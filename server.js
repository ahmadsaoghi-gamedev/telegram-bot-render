// server.js (CommonJS) — Webhook-ready
...
SHReels`;
  return bot.sendMessage(chatId, text, {
    ...
    reply_markup: {
      inline_keyboard: [
        // PENTING: web_app agar terbuka DI DALAM Telegram, bukan browser
        [{ text: '📱 Buka Aplikasi', web_app: { url: 'https://tele-stream-wizard-b2pvpuoal-ahmadsaoghis-projects.vercel.app/' } }],
...
// /start (perbaiki regex: \s cukup satu backslash)
